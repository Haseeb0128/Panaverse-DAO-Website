...
export default function Courses() {
    ...
    return (
        ...
        <RevealList interval={60} delay={500} reset={true} origin="left">
        ...
        <Flex justify={"space-evenly"} mt="25px" direction={{base:"column", md:"column", lg:"row"}} align="center" gap={{lg:"20px",md:"25px",base:"25px"}}>
          ...
          <Link href={'/Courses/Core2'}><Box transition={"transform 0.3s"} _hover={{ transform: "scale(1.1)" }}  bg="#CECCCC" boxShadow={"dark-lg"} w={{lg:"320px", md:"500px",base:"300px"}} h="195px" borderRadius={"12px"} pt="30px">
            <Text textShadow="2px 2px 4px rgba(0, 0, 0, 0.25)" textAlign={"center"} fontSize={"30px"} fontWeight="600">Quarter 2</Text>
          ...
          <Link href={'/Courses/Core3'}><Box transition={"transform 0.3s"} _hover={{ transform: "scale(1.1)" }}  bg="#CECCCC" boxShadow={"dark-lg"} w={{lg:"320px", md:"500px",base:"300px"}} h="195px" borderRadius={"12px"} pt="30px">
            <Text textShadow="2px 2px 4px rgba(0, 0, 0, 0.25)" textAlign={"center"} fontSize={"30px"} fontWeight="600">Quarter 3</Text>
      ...
      <Box>
          <Flex justify={"space-evenly"} mt="25px" direction={{base:"column", md:"column", lg:"row"}} gap={{lg:"20px",md:"25px",base:"25px"}} align={"center"}>
            ...
            <Link href={'/Courses/WMQ5'}>
              <Box bg="#CECCCC" transition={"transform 0.3s"} _hover={{ transform: "scale(1.07)" }} boxShadow={"dark-lg"} w={{lg:"500px",md:"500px",base:"300px"}} h="195px" borderRadius={"12px"} pt="15px">
                <Text textShadow="2px 2px 4px rgba(0, 0, 0, 0.25)" textAlign={"center"} mt="25px" fontSize={"30px"} fontWeight="600">Quarter 5</Text>
        ...
        <Container maxW={{base:"auto", lg:"1366"}} px={{lg:"40px", base:"20px", md:"30px"}} mb="120px">
          <RevealList interval={60} delay={500} origin="bottom" reset={true} distance="100px">
