...
import { BsGithub, BsGlobe2, BsCameraVideo } from 'react-icons/Bs'
import {MdOutlineOfflineBolt} from 'react-icons/Md'
import { AiOutlineAmazon } from 'react-icons/Ai'
import {FiFigma} from 'react-icons/Fi'
import {SiAmazonaws, SiFreecodecamp, SiNextdotjs, SiPrisma} from 'react-icons/Si'
...
export default function Home() {
  return (
    <>
      ...
      <HStack>
      <Icon as={MdOutlineOfflineBolt} w="20px" h="20px" />
...
<Box bg="#50E09F" w={{lg:"500px",md:"500px", base:"320px"}} borderRadius={"12px"}>
      ...
      <Box bg="#50E09F" w={{lg:"500px",md:"500px", base:"320px"}} h="119px" borderRadius={"12px"}>
      <VStack align={"start"} p="20px">
