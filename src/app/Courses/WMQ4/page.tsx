        ...
        <>
            ...
            <Center mt="10px">
                <Flex gap={"20px"} direction={{ lg: "row", md: "column", base: "column" }} align={{ base: "center", lg: "initial" }}>
                    ...
                    <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"203px",md:"155px",lg:"155px"}} borderRadius={"12px"}>
                    ...
                    <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"182px",md:"131px",lg:"155px"}} borderRadius={"12px"}>
                        <VStack align={"start"} p="20px">
            ...
            <Center mt="20px">
                <Flex gap="20px" direction={{ lg: "row", md: "column", base: "column" }} align={{ base: "center", lg: "initial" }}>
                    <VStack gap={"12px"}>
                    <RevealWrapper reset={true} origin="left">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{ lg: "100px", base: "120px" }} borderRadius={"12px"}>
                            <VStack align={"start"} p="20px">
                        ...
                        <RevealWrapper reset={true} origin="left">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"67px", md:"67px", lg:"67px"}} borderRadius={"12px"} p="20px">
                            <Text fontSize={"18px"} fontWeight="640">Tokennomics</Text>
                        </Box>
                        </RevealWrapper>
                        <RevealWrapper reset={true} origin="left">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"814px", md:"622px", lg:"622px"}} borderRadius={"12px"}>
                            <VStack align={"start"} p="20px">
                    ...
                    <RevealWrapper reset={true} origin="right" distance="15px">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"262px", md:"214px", lg:"214px"}} borderRadius={"12px"}>
                            <VStack align={"start"} p="20px">
                        ...
                        <RevealWrapper reset={true} origin="right" distance="15px">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"230px", md:"155px", lg:"155px"}} borderRadius={"12px"}>
                            <VStack align={"start"} p="20px">
                        ...
                        <RevealWrapper reset={true} origin="right" distance="15px">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} borderRadius={"12px"} h={{ lg: "420px", md: "396px", base: "570px" }}>
                            <VStack align={"start"} p="20px">
            ...
            <Center mt="20px">
                <Flex gap="20px" direction={{ lg: "row", md: "column", base: "column" }} align={{ base: "center", lg: "initial" }}>
                <RevealWrapper reset={true} origin="left">
                    <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"1062px",md:"723px",lg:"723px"}} borderRadius={"12px"}>
                        <VStack align={"start"} p="20px">
                    ...
                    <RevealWrapper reset={true} origin="right" distance="15px">
                    <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"1070px",md:"683px",lg:"723px"}} borderRadius={"12px"}>
                        <VStack align={"start"} p="20px">
            ...
            <Center mt="20px" mb="120px">
                <Flex gap="20px" direction={{ lg: "row", md: "column", base: "column" }} align={{ base: "center", lg: "initial" }}>
                    <VStack gap={"12px"}>
                    <RevealWrapper reset={true} origin="left">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} borderRadius={"12px"} h={{ lg: "155px", md: "155px", base: "180px" }}>
                            <VStack align={"start"} p="20px">
                        ...
                        <RevealWrapper reset={true} origin="left">
                        <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} borderRadius={"12px"} h={{ lg: "155px", md: "160px", base: "200px" }}>
                            <VStack align={"start"} p="20px">
                    ...
                    <RevealWrapper reset={true} origin="right" distance="15px">
                    <Box bg="#CECCCC" w={{ lg: "500px", md: "500px", base: "320px" }} h={{base:"374px",md:"302px",lg:"330px"}} borderRadius={"12px"}>
                        <VStack align={"start"} p="20px">
