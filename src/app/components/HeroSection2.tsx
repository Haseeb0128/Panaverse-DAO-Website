...
export default function HeroSection2() {
  return (
    <Container bg="white" px={{ lg: "60px", md: "50px", base: "40px" }} maxW={{ lg: "1500px", md: "auto", base: "auto" }} minH={{ base: "900px", md: "auto", lg: "auto" }} py={{ base: "50px", md: "70px", lg: "80px" }}>
      <Flex direction={{ lg: "row", md: "column", base: "column" }}>
        ...
        <Container flexBasis={"50%"} h={{ lg: "340px", md: "400px", base: "530px" }} w={{ lg: "590px", md: "600px", base: "300px" }} mt={"50px"} alignItems={{ lg: "left", md: "left", base: "center" }}>
      ...
      <RevealList interval={60} delay={200} origin="top" reset={true} distance="100px">
          ...
          <Box px={{ lg: "120px", base: "20px" }} mb="120px">
