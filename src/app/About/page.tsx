"use client"
import { Box, Flex, Heading, Text, Container, Spacer, Grid, Image } from '@chakra-ui/react'
...
export default function About() {
    return (
      <>
        ...
        <Container bg={"white"} mt="120px" maxW={{lg:"1500px",md:"auto" ,base:"auto"}}>
        <Flex px={{lg:"70px", md:"30px", base:"8px"}} direction={{lg:"row", md:"column-reverse", base:"column-reverse"}}>
            <Box bg={"white"} h={{lg:"390px", base:"auto"}} w={{lg:"600px", base:"auto"}} pt="70px" textAlign={{base:"center", md:"left"}}>
