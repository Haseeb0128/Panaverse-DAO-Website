...
export default function Leaders() {
    return (
      <>
        ...
        <Flex direction={{base:"column-reverse", lg:"row"}}  gap={{base:"30px", lg:"50px"}}>
            <Box  h={{lg:"auto",md:"auto" ,base:"auto"}} maxW={{lg:"590px",md:"500px",base:"300px"}}  alignItems={{lg:"left", md:"left", base:"center"}} flexBasis="50%">
    ...
    <Center px={{lg:"50px",md:"50px" ,base:"40px"}} maxW={{lg:"1500px",md:"auto" ,base:"auto"}} mb="100px">
        <Flex direction={{base:"column", lg:"row"}}  gap={{base:"30px", lg:"50px"}}>
        <Box alignItems={{lg:"left", md:"center", base:"center"}} flexBasis="50%">
            <RevealList interval={60} reset={true} origin={"left"} duration={1000} distance="50px" delay={200}>
            <Image src={"/images/daniyal.jpg"} alt="GirldwithVrHeadSet" height={534} width={440} />
            </RevealList>
            </Box>
            <Box h={{lg:"auto",md:"auto" ,base:"auto"}} maxW={{lg:"590px",md:"500px",base:"300px"}} mt={{lg:"0px", base:"20px"}}  alignItems={{lg:"left", md:"left", base:"center"}} flexBasis="50%">
            <RevealList interval={60} reset={true} origin='right' duration={1000} distance="30px" delay={200}>
