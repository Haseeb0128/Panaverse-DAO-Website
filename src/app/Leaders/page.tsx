    ...
    return (
      <>
        ...
        <Flex justify={"space-evenly"} direction={{lg:"row", md:"column", base:"column"}} align={{base:"center"}} gap={{base:"20px"}}>
          ...
          <Box mt="35px" ml="70px">
          <HStack gap={"17px"}>
          <Link href={'https://www.facebook.com/ziakhan'} target="_blank"><Image src='/images/fb.svg' alt='facebook' /></Link>
                <Link href={'https://twitter.com/ziakhan'} target="_blank"><Image src='/images/tw.svg' alt='twitter' /></Link>
                <Link href={'https://www.linkedin.com/in/ziaukhan/?originalSubdomain=pk'} target="_blank"><Image src='/images/lin.svg' alt='linkedin' /></Link>
          </HStack>
          </Box>
          </Box>
          <Box bg="#50E09F" w="334px" h="430px" borderRadius={"12px"}>
          ...
          <HStack gap={"17px"}>
          <Link href={'https://www.facebook.com/daniyalnagori1237'} target="_blank"><Image src='/images/fb.svg' alt='facebook'/></Link>
                <Link href={'https://twitter.com/daniyalnagori1'} target="_blank"><Image src='/images/tw.svg' alt='twitter' /></Link>
                <Link href={'https://www.linkedin.com/in/daniyalnagori/?originalSubdomain=pk'} target="_blank"><Image src='/images/lin.svg' alt='linkedin' /></Link>
          </HStack>
          </VStack>
          </Box>
          <Box bg="#50E09F" w="334px" h="430px" borderRadius={"12px"}>
          ...
          <Link href={'https://www.facebook.com/ziakhan'} target="_blank"><Image src='/images/fb.svg' alt='facebook' /></Link>
                <Link href={'https://twitter.com/ziakhan'} target="_blank"><Image src='/images/tw.svg' alt='twitter' /></Link>
                <Link href={'https://www.linkedin.com/in/hira-khan-76523540/?originalSubdomain=pk'} target="_blank"><Image src='/images/lin.svg' alt='linkedin' /></Link>
          </HStack>
          </Box>
          </Box>
        </Flex>
