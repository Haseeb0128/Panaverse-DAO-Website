...
export default function Leaders() {
    return (
      <>
        ...
        <Container px={{lg:"50px",md:"50px" ,base:"40px"}} maxW={{lg:"1500px",md:"auto" ,base:"auto"}} mb="100px">
        <Flex direction={{base:"column-reverse", lg:"row"}}  gap={{base:"0px"}}>
            <Container h={{lg:"auto",md:"auto" ,base:"auto"}} maxW={{lg:"590px",md:"500px",base:"300px"}} pt="60px"  mt={{lg:"50px", base:"20px"}}  alignItems={{lg:"left", md:"left", base:"center"}} flexBasis="50%">
            ...
            <Container  mt={"22px"} alignItems={{lg:"left", md:"center", base:"center"}} flexBasis="50%">
            <RevealList interval={60} reset={true} origin={"right"} duration={1000} distance="50px" delay={200}>
    ...
    <Container px={{lg:"50px",md:"50px" ,base:"40px"}} maxW={{lg:"1500px",md:"auto" ,base:"auto"}} mb="100px">
        ...
        <Container  mt={"22px"} alignItems={{lg:"left", md:"center", base:"center"}} flexBasis="50%">
            ...
            <Container h={{lg:"auto",md:"auto" ,base:"auto"}} maxW={{lg:"590px",md:"500px",base:"300px"}} pt="60px"  mt={{lg:"0px", base:"20px"}}  alignItems={{lg:"left", md:"left", base:"center"}} flexBasis="50%">
            <RevealList interval={60} reset={true} origin='right' duration={1000} distance="50px" delay={200}>
    ...
    <Container px={{lg:"50px",md:"50px" ,base:"40px"}} maxW={{lg:"1500px",md:"auto" ,base:"auto"}} mb="120px">
        <Flex direction={{base:"column-reverse", lg:"row"}}  gap={{base:"0px"}}>
            <Container h={{lg:"auto",md:"auto" ,base:"auto"}} maxW={{lg:"590px",md:"500px",base:"300px"}} pt="60px"  mt={{lg:"0px", base:"20px"}}  alignItems={{lg:"left", md:"left", base:"center"}} flexBasis="50%">
            <RevealList interval={60} reset={true} origin='left' duration={1000} distance="50px" delay={200}>
